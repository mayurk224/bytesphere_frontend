      ...
      >
        <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
          <ul class="space-y-2 font-medium">
            <li onClick={() => setActiveComponent("RenderComponent")}>
              <a
            ...
            <li onClick={() => setActiveComponent("AllFiles")}>
              <a
            ...
            <li onClick={() => setActiveComponent("Folders")}>
              <a
              ...
              >
                ...
                <span class="flex-1 ms-3 h-5 whitespace-nowrap">
                  Folders Space
                </span>
              </a>
            </li>
            <li onClick={() => setActiveComponent("RecycleBin")}>
              <a
                class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                <svg
                ...
                <span class="flex-1 ms-3 whitespace-nowrap">Recycle Bin</span>
              </a>
            </li>
          </ul>
        </div>

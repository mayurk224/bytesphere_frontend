  ...
  return (
    ...
    <div className="h-32 overflow-hidden relative">
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-start justify-end p-2">
        ...
        >
          <svg 
            className={`w-4 h-4 ${isStarred ? 'text-yellow-400 fill-current' : 'text-gray-300'}`} 
      ...
      {/* Bottom overlay with download button - visible on hover */}
    ...
    <div className="p-2">
      <div className="flex items-center justify-between">
        <h3 className="text-sm font-medium text-white truncate">Sample File</h3>
        <span className="text-xs text-indigo-300 font-medium">JPG</span>
      </div>
      <div className="flex items-center mt-1">
        <svg className="w-3 h-3 text-gray-400 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
